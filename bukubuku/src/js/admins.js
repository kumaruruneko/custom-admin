...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/admins.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _mediauploader_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mediauploader.js */ "./js/mediauploader.js");
 //リロード等の読み込み時は初期状態からチェックが入っているため、関数で判定を行う

checkedLimit();
checkedLimit_area(); //チェック時に制限チェックの関数で判定を行う
...
function checkedLimit() {
  ...
  var len = $('#feature_box input:checkbox:checked').length; //2つ目のチェックが入ったら、残りのチェックボックスを触れなくする
...
function checkedLimit_area() {
  ...
  var len = $('#area_box input:checkbox:checked').length; //規定数のチェックが入ったら、残りのチェックボックスを触れなくする
...
$('#taxonomy-pref-term #pref-termchecklist').html($('#taxonomy-pref-term #pref-termchecklist>li').sort(function (a, b) {
  // 昇順
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return openUpload; });
// キャッシュを格納
var setMedia = [];
/******************************************************
				GETの値を取得する
...
function openUpload(btn) {
  ...
  var targetId = 'target_' + $(btn.type).index($(btn)); // キャッシュを表示する
  ...
  setMedia[targetId].on('select', function () {
    ...
    images.each(function (file) {
      ...
      input.val('');
      box.empty();
      input.val(file.id); // /* プレビュー用に選択されたサムネイル画像を表示 */
